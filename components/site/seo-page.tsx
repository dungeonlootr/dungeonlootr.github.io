...
export function SeoPage({ page }: { page: SeoPageDefinition }) {
  ...
  const [answerSection, ...remainingSections] = page.sections;
  ...
  return (
    <>
      ...
      <main>
        <section className="hero-surface border-b border-border">
          <div className="site-container py-12 sm:py-16">
            ...
            <p className="mt-6 flex items-center gap-2 text-sm text-muted-foreground">
              ...
              {page.pageType === "codes" ? "Last checked" : "Last updated"}: <time dateTime={page.lastReviewed}>{page.lastReviewed}</time>
            </p>
          </div>
        </section>
        ...
        {answerSection ? <div className="site-container py-10 sm:py-12"><PageSections sections={[answerSection]} /></div> : null}
